...
// 1. What is "this" when joe.scope() is invoked?  It returns: Student {name: 'Joe', age: 'Schmoe', hometown: 100}
//
// 2. What is "this" when joe.scopeArrow() is invoked? It represents the global object 'Window'.
//
// 3. Explain why "this" is different when an arrow function is used. Arrow function expressions should only be used for non-method functions because they do not have their own `this`.
//
